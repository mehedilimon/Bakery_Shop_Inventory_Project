    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                        ...
                        <p class="text-muted mb-5">Rupnagar Residential Area, Mirpur 2, Dhaka-1216</p>
                        <h4 class="fw-bold">Contact Us</h4>
                        <p class="text-muted mb-1">mehedilimon1@gmail.com</p>
                        <p class="text-muted mb-0">+8801780542330</p>
                    </div>
                    <div class="col-12 col-lg-6 offset-lg-1">
                        <form action="#">
        ...
        <footer class="py-5 bg-light">
            <div class="container text-center pb-5 border-bottom">
                ...
                <div>
                    <a class="d-inline-block me-4" href="https://www.facebook.com/mehedilimon1/">
                        <img src="{{asset('/images/facebook.svg')}}">
                    </a>
                    {{-- <a class="d-inline-block me-4" href="#">
                        <img src="{{asset('/images/twitter.svg')}}">
                    </a> --}}
                    <a class="d-inline-block me-4" href="https://github.com/mehedilimon">
                        <img src="{{asset('/images/github.svg')}}">
                    </a>
                    {{-- <a class="d-inline-block me-4" href="#">
                        <img src="{{asset('/images/instagram.svg')}}">
                    </a> --}}
                    <a class="d-inline-block" href="https://www.linkedin.com/in/mehedilimon/">
            ...
            <div class="mb-5"></div>
            <div class="container">
                <p class="text-center">All rights reserved © Mehedi Hasan Limon-2024</p>
            </div>
        </footer>
